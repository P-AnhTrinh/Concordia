...
public class Network extends Thread {
    ...
    private static Semaphore emptyIn = new Semaphore(10);
    private static Semaphore fullIn = new Semaphore(0);
    private static Semaphore emptyOut = new Semaphore(10);
    private static Semaphore fullOut = new Semaphore(0);
