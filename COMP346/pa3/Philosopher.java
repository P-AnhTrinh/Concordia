...
public class Philosopher extends BaseThread
{
	...
	public void eat()
	{
		try
		{
			...
			yield();
			System.out.println("Philosopher " + this.getTID() + " has done eating");
			// ...
		}
	...
	public void think()
	{
		...
		try
		{
			...
			yield();
			System.out.println("Philosopher " + this.getTID() + " has done thinking");
			// ...
		}
		catch(InterruptedException e)
		{
	...
	public void talk()
	{
		...
		try {
			...
			sleep((long) (Math.random() * TIME_TO_WASTE));
			yield();
			System.out.println("Philosopher " + this.getTID() + " has done talking");
			// ...
		}
		catch(InterruptedException e)
		{
